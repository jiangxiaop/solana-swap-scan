...
import { getLatestSnapshotByType } from "../../service/snapshot/snapshot.ts";
import { SnapshotForTokenAndWalletTrading } from "../../snap-shot/index.ts";
...
if (import.meta.main) {
    ...
    snapshotScheduler.start().catch(console.error);
}
