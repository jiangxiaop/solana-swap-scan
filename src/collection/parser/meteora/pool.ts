...
import { convertToUiAmount, PoolEvent, PoolEventType, TransferData } from '../../../type/index.ts';
import { MeteoraLiquidityParserBase } from './lp-base.ts';
...
export class MeteoraPoolsParser extends MeteoraLiquidityParserBase {
    ...
    protected override parseCreateLiquidityEvent(
        instruction: any,
        index: number,
        data: Buffer,
    ...
    protected override parseAddLiquidityEvent(
        instruction: any,
        index: number,
        data: Buffer,
        transfers: TransferData[]
